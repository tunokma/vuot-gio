...
@Controller
@ComponentScan
public class UserTongHopController {

    private static final Logger logger = LoggerFactory.getLogger(UserTongHopController.class);
    @Autowired
    ...
    public String statistic(Model model) {
        ...
        GiangVien gv = giangVienService.findByUsername(username);
        giangVienId = gv.getId();
        listGiangDay = giangDayService.findByObjectId(giangVienId, namHocNay);
        listNckh = nckhService.findByObjectId(giangVienId, namHocNay);
        listHdTotNghiep = hdTotNghiepService.findByObjectId(giangVienId, namHocNay);

        loadMap();
        TongHop tongHop = tongHopService.findByObjectId(gv.getId(), namHocNay);
        ...
        Long soTietA = giangDayService.getSoTietDaDay(gv.getId(), namHocNay);
        Long soTietB = hdTotNghiepService.getSoTietByObjectId(gv.getId(), namHocNay);
        ...
        List<TbdNckh> lstNckhs = nckhService.findByObjectId(giangVienId, namHocNay);
    ...
    @RequestMapping(value = "/user-tongHop/exportWord", method = RequestMethod.GET)
